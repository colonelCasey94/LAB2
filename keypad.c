	...
	char key = -1;
        ...
        for(row = 1; row < 5; row++){
            if(row == 1){
                ...
                if(COL1 == LOW && COL2 == HIGH && COL3 == HIGH){ key = '1'; count++;}
                if(COL1 == HIGH && COL2 == LOW && COL3 == HIGH){ key = '2'; count++;}
                if(COL1 == HIGH && COL2 == HIGH && COL3 == LOW){ key = '3'; count++;}
                ...
                if(COL1 == LOW && COL2 == HIGH && COL3 == HIGH){ key = '4'; count++;}
                if(COL1 == HIGH && COL2 == LOW && COL3 == HIGH){ key = '5'; count++;}
                if(COL1 == HIGH && COL2 == HIGH && COL3 == LOW){ key = '6'; count++;}
                ...
                if(COL1 == LOW && COL2 == HIGH && COL3 == HIGH){ key = '7'; count++;}
                if(COL1 == HIGH && COL2 == LOW && COL3 == HIGH){ key = '8'; count++;}
                if(COL1 == HIGH && COL2 == HIGH && COL3 == LOW){ key = '9'; count++;}
                ...
                if(COL1 == LOW && COL2 == HIGH && COL3 == HIGH){ key = '*'; count++;}
                if(COL1 == HIGH && COL2 == LOW && COL3 == HIGH){ key = '0'; count++;}
                if(COL1 == HIGH && COL2 == HIGH && COL3 == LOW){ key = '#'; count++;}
